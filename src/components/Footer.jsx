    ...
    <div className='' style={{backgroundColor:"black", fontFamily:'serif'}}>
      <div className='container mt-5'>
          <div className='p-lg-3'>
            ...
            <div>
              <span className='fs-5 d-flex text-white justify-content-center'>Facing any issue? Contact: 7972121969</span>
            </div>
            <div className='d-flex text-white justify-content-center fs-3 mt-lg-3 mt-md-3 mt-sm-3 mt-3'>Any Feedback:</div>
            <div className='col-lg-12 col-md-12 col-sm-12 col-12'>
              <div className='d-flex justify-content-center m-auto  w-75'>
          ...
          <div className='col-lg-12 d-flex gap-lg-5 gap-5 mt-lg-3 mt-3 justify-content-center'>
